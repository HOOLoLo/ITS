...
function generateLayerTests(_ref) {
  ...
  testCases.push.apply(testCases, (0, _toConsumableArray2["default"])(makeAltDataTestCases(sampleProps, propTypes)));
  ...
  for (var propName in Layer.defaultProps) {
    if (!(propName in sampleProps)) {
      ...
      testCases.push.apply(testCases, (0, _toConsumableArray2["default"])(newTestCase));
    }
  }
    ...
    testCase.onAfterUpdate = function (params) {
      ...
      if (runDefaultAsserts) {
        if (params.layer.isComposite) {
          ...
          if (data && (0, _typeof2["default"])(data) === 'object' && (0, _core._count)(data)) {
    ...
    case 'accessor':
      {
        ...
        newProps.updateTriggers = (0, _defineProperty2["default"])({}, propName, 'function');
        ...
        return [{
          ...
          updateProps: {
            updateTriggers: (0, _defineProperty2["default"])({}, propName, 'function+trigger')
          },
          onBeforeUpdate: onBeforeUpdate,
          onAfterUpdate: onAfterUpdate
        }];
